...
On some operating systems, an error is signalled if
~CONNECT-TO-IPV4-TCP-SERVER~ tries to connect to a non existent server
on the ~+IPV4-LOOPBACK+~ host address.
